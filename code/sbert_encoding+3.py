...
def _get_sbert_features(narrative: str, modelname: str, layer: int = None, use_sentence_embedding: bool = False):
    ...
    pkl_path = f"/home/s-kawashima/research/output/features/{modelname}_cumulative_add_three-sentences/narrative-{narrative}.pkl"
    ...
    # パス変更: _add_two-sentences
    h5_path = f"/home/s-kawashima/research/output/features/{modelname}_cumulative_add_three-sentences/narrative-{narrative}.h5"
...
def encoding(modelname, layer, use_sentence_embedding, alphas, jobs, device, suffix, root, mask_path, pkl_dir=None, clean_dir=None, force_reload=False, run=None, **kwargs):
    ...
    save_datatype = f"{modelname}_cumulative_{layer_info}_add_three-sentences"
